...
export namespace sourceMapTest {
    ...
    export function getSourceTest() {
        ...
        assert.deepEqual(clean(b.getSource(0, 0, true, true)), {});
        assert.deepEqual(clean(b.getSource(0, 1, true, true)), {});
        assert.deepEqual(clean(b.getSource(0, 2, true, true)), {});
        ...
        assert.deepEqual(clean(b.getSource(0, 0, false, false)), {});
        assert.deepEqual(clean(b.getSource(1, 5, false, false)), { sourcePath: "source.js", line: 0, column: 0 });
        assert.deepEqual(clean(b.getSource(100, 1, false, false)), {});
    ...
    export function getAllGeneratedTest() {
        ...
        assert.deepEqual(clean(b.getAllGenerated("source.js", 0, 17)), [
            { sourcePath: "source.js", line: 3, column: 18 }
        ]);
        assert.deepEqual(clean(b.getAllGenerated("source.js", 0)), [
            ...
            { sourcePath: "source.js", line: 3, column: 0 },
            { sourcePath: "source.js", line: 3, column: 6 },
            { sourcePath: "source.js", line: 3, column: 9 },
            { sourcePath: "source.js", line: 3, column: 18 },
            { sourcePath: "source.js", line: 3, column: 19 }
        ]);
    ...
    export function applySourceMapTest() {
        ...
        a.applySourceMap(b);
        assert.deepEqual(clean(a.getSource(1, 1, true, true)), {});
        assert.deepEqual(clean(a.getSource(1, 2, true, true)), {});
        assert.deepEqual(clean(a.getSource(1, 3, true, true)), { sourcePath: "goo.js", line: 201, column: 202, name: "name" });
        assert.deepEqual(clean(a.getSource(1, 4, true, true)), { sourcePath: "goo.js", line: 201, column: 203, name: "name" });
        assert.deepEqual(clean(a.getSource(1, 5, true, true)), { sourcePath: "goo.js", line: 201, column: 204, name: "name" });
